vm_id = 112420
vm_name = "windows-11-24h2-x64-enterprise-eval-noup-template"
...
#iso_file = "local:iso/en-us_windows_11_24h2_x64_business_editions_version.iso"
os = "win11"
uptodate = false
vm_disk_size = "60G"
description = "Windows 11 24H2 64-bit Enterprise without security update"
